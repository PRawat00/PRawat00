...
- 🌱 I'm currently learning **Model optimization (LoRA/QLoRA, PEFT, vLLM), distributed training (DDP, AMP), and Big Data systems (Spark, Kafka, Airflow, Databricks)**

- 👯 I'm looking to collaborate on **RAG systems, agentic AI workflows, LLM fine-tuning & deployment, and production MLOps pipelines**

- 🤝 I'm looking for help with **Scaling vector databases, optimizing LLM inference latency, and advanced distributed ML training**
